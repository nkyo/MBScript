...
define('APP_TITLE', 'MBscript File Manager');

$use_auth = true;
$auth_users = array(
    'userfilemanager' => password_hash('passwordfilemanger', PASSWORD_DEFAULT)
);
...
$favicon_path = 'https://www.matbao.net/Content/images/favicon.ico';
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                       <img src="https://www.matbao.net/Content/images/logo-matbao-net.svg?ver=1" alt="Đăng ký mua tên miền, Domain, Thuê Hosting, Server, VPS, Email chuyên nghiệp">
                                        </div>
                        ...
                        <div class="footer text-center">
                            <p class="text-muted" data-version="<?php echo VERSION; ?>">&mdash;&mdash; &copy; MBScript</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<form action="" method="post" class="pt-3">
        ...
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            if (empty($folders) && empty($files)) {
                ...
                <tfoot>
                    <tr><?php if (!FM_READONLY): ?>
                            <td></td><?php endif; ?>
                        <td colspan="<?php echo (!FM_IS_WIN && !$hide_Cols) ? '6' : '4' ?>"><em><?php echo lng('Empty') ?></em></td>
                    </tr>
                </tfoot>
                <?php
            } else {
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><p class="float-right text-muted">MBscript File Manager <?php echo VERSION; ?></p></div>
        <?php else: ?>
            <div class="col-12"><p class="float-right text-muted">MBscript File Manager <?php echo VERSION; ?></p></div>
        <?php endif; ?>
    </div>
...
<head>
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            a, a:hover, a:visited, a:active, #main-table .filename a { color: #ef9b1e; }
            ul#search-wrapper li:nth-child(odd) { background: #f9f9f9cc; }
            .theme-dark .btn-outline-primary { color: #ef9b1e; border-color: #ef9b1e; }
